...
import { Texture, Quad, Geometry, Program } from '@pixi/core';
import { Mesh, MeshMaterial } from '@pixi/mesh';
import { Group } from '@pixi/layers';
import { Matrix, Circle, Point } from '@pixi/math';
...
class ViewportQuad extends Quad
{
    update(viewport)
    {
 ...
 */
class LightShader extends MeshMaterial
{
    constructor(options)
    {
        const uniforms = {
...
class AmbientLightShader extends LightShader
{
    ...
    static __initStatic() {this._program= new Program(LightShader.defaultVertexSrc, fragment$2);}
...
class PointLightShader extends LightShader
{
    ...
    static __initStatic() {this._program= new Program(LightShader.defaultVertexSrc, fragment$1);}
...
class DirectionalLightShader extends LightShader
{
    ...
    static __initStatic() {this._program= new Program(LightShader.defaultVertexSrc, fragment);}
...
export { AmbientLight, AmbientLightShader, DirectionalLight, DirectionalLightShader, LayerFinder, Light, LightShader, PointLight, PointLightShader, ViewportQuad, diffuseGroup, lightGroup, normalGroup };
